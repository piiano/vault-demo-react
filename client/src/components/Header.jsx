...
import { NavProfile, MobileProfile } from './Profile'
...
function MobileNavLink({ href, onClick, children }) {
  return (
    <Popover.Button as={Link} onClick={onClick} to={href} className="block w-full p-2 text-gray-600 hover:text-gray-900">
      {children}
    </Popover.Button>
  )
}
      ...
      <Container>
        ...
        <div className="flex items-center md:gap-x-12">
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            {isLoggedIn ? (
              <NavProfile className="hidden md:block" />
            ) : (
              <>
